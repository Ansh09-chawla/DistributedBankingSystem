...
public class LockManager {
    ...
    private LockManager() {
        try {
            this.socketHandler = new SocketHandler("localhost", 2025);
            this.socketHandler2 = new SocketHandler("54.213.239.61", 2027);
            this.socketHandlerRead = new SocketHandler("54.213.239.61", 2028);
